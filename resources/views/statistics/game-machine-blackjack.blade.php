    ...
    <div class="row">
      <div class="col-md-9">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="javascript:ajaxLoad('{{url('statistics/game-machine-blackjack')}}')">@lang('messages.Blackjack')</a></li>
        ...
        <div class="panel panel-default" id="panelTerminatsContend">
            <div class="panel-heading" id="socketConect">
                ...
                <div class="panel-body" >
                    <input id="pageReload" type="hidden" val="" data-URL="javascript:ajaxLoad('{{url('statistics/game-machine-blackjack')}}" data-excel-url="{{ route('export2excelGameBJ') }}" data-OrderQuery="{{ $page['OrderQuery']}}" data-desc="{{ $page['OrderDesc']}}" > 
