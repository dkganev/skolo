<div class="container">
    ...
    <div class=" "> 
        <div class="" style="">
            <ul class="breadcrumb">
              <li><a href="javascript:ajaxLoad('{{url('statistics/historyRoulette')}}')">@lang('messages.Roulette History Statistics')</a></li>
              <li class="active"><a href="javascript:ajaxLoad('{{url('statistics/winRTL1')}}')">@lang('messages.Wheel Statistics')</a></li>
            </ul>
        </div>
