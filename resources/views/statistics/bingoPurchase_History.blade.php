    ...
    <tbody>
        ...
        @foreach($bingoPurchase_Historys as $bingoPurchase_History)
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#bingoHistory2_modal" onclick='boxModalWindow2({{ $bingoPurchase_History->bingo_seq}}, "{{$bingoPurchase_History->unique_game_seq}}", {{$bingoPurchase_History->psid }});' style="float: left;" tabindex="0">
