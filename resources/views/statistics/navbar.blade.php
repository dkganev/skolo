    ...
    <div class="col-md-12 "> 
        <div style="padding-top:6px; margin-top: 0px;">
            <ul class="breadcrumb">
                ...
                <li id="menuHistory"><a href="javascript:ajaxLoad('{{url('statistics/history')}}')">@lang('messages.Game History')</a></li>
                @endhasanyrole

                <li id="menuGameMachineBingo"><a href="javascript:ajaxLoad('{{url('/statistics/game-machine-bingo')}}')">@lang('messages.Machine Game Statistics')</a></li>

                <li id="menuUserLogs"><a href="javascript:ajaxLoad('{{url('/statistics/user-logs')}}')">@lang('messages.User Logs')</a></li>
            </ul>
        </div>
    </div>
</div>
