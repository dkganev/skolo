    ...
    <div class="row">
      <div class="col-md-9">
        <ul class="breadcrumb">
          ...
          <li class="active"><a href="javascript:ajaxLoad('{{url('/statistics/game-machine-rl2')}}')">@lang('messages.Roulette') 2</a></li>
        </ul>
      </div>
    </div>
</div>
        ...
        <div class="panel panel-default" id="panelTerminatsContend">
            <div class="panel-heading" id="socketConect">
                ...
                <div class="panel-body" >
                    <input id="pageReload" type="hidden" val="" data-URL="javascript:ajaxLoad('{{url('statistics/game-machine-rl2')}}" data-excel-url="{{ route('export2excelGameR2') }}" data-OrderQuery="{{ $page['OrderQuery']}}" data-desc="{{ $page['OrderDesc']}}" > 
