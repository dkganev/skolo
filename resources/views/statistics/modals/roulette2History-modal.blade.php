        ...
        <div  style="display: show; min-width: 1400px; min-height: 300px; border: 1px solid #000000; text-align: left; position: absolute; color: black; background-color: #ffffff; overflow: hidden; ">
            ...
            <div class="modal-body" >
                ...
                <div style='text-align: center;'>
                    ...
                    <a><i id='prevArrowR' class="fa fa-angle-left" style="color: #333; font-size: 20px;" onclick='changeModalWindowR2("Prev");'></i></a>
                    &nbsp;&nbsp;Game: <span id="gameIDArrowR">&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;
                    <a><i id='nextArrowR' class="fa fa-angle-right" style="color: #333; font-size: 20px;" onclick='changeModalWindowR2("Next");'></i></a>
                </div>
            </div>    
