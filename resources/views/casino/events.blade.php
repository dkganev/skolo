            ...
            <div class="panel-body" style="border: 1px solid #d1d1e0; border-radius:5px">
                <table  class="table table-striped table-bordered table-hover data-table-table" id="terminals-table" role="grid"
                    ...
                    <thead class="w3-dark-grey">
                        ...
                        <tr>
                            <th class="text-center " data-sortable="true" onclick="changePageSortEvents('sequence', '{{ $page['OrderDesc'] == 'asc' ? 'desc' : 'asc' }}');">@lang('messages.Sequence')<i class="fa {{ $page['OrderQuery'] == 'sequence' ? ( $page['OrderDesc'] == 'asc' ? 'fa-sort-asc' : 'fa-sort-desc' ) : 'fa-sort' }} pull-right" aria-hidden="true"></i></th>
                            ...
                            <th class="text-center col-lg-3" data-sortable="true" onclick="changePageSortEvents('time_server', '{{ $page['OrderDesc'] == 'asc' ? 'desc' : 'asc' }}');">@lang('messages.Time')<i class="fa {{ $page['OrderQuery'] == 'time_server' ? ( $page['OrderDesc'] == 'asc' ? 'fa-sort-asc' : 'fa-sort-desc' ) : 'fa-sort' }} pull-right" aria-hidden="true"></i></th>
                        </tr>
                    </thead>
                    <tbody>
