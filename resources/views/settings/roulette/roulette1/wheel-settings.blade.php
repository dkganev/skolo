        ...
        <div class="col-lg-12">
            <div style="padding-top:2px; margin-top: 0px; background-color: none;">
                <ul class="breadcrumb" style="margin-bottom: 10px;">
                    ...
                    <li class="active"><a href="javascript:ajaxLoad('{{url('/settings/roulette1/wheelsettings')}}')">@lang('messages.Wheel Settings')</a></li>
...
{{--         <a class="btn btn-warning  btn-sm pull-left" href="/settings/blackjack/table/export">
