...
class UserLogsController extends Controller
{
    ...
    public function system(Request $request)
    {
        ...
        //$logs = UserLogs::orderBy('created_at', 'asc')->get();
        //return view('statistics.user-logs', compact('logs'));
        return view('statistics.user-logs-system', ['historys' => $historys, 'page' => $page ]);
    }
    
    public function export2excelSystem(Request $request)
    {
        if ($request['rowsPerPage']) {
            $page['rowsPerPage'] = $request['rowsPerPage'];
    ...
    public function settings(Request $request)
    {
        ...
        //$logs = UserLogs::orderBy('created_at', 'asc')->get();
        //return view('statistics.user-logs', compact('logs'));
        return view('statistics.user-logs-settings', ['historys' => $historys, 'page' => $page ]);
    }
    
    public function export2excelSettings(Request $request)
    {
        if ($request['rowsPerPage']) {
            $page['rowsPerPage'] = $request['rowsPerPage'];
