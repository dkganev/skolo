...
class CasinoController extends Controller
{
    ...
    public function getCasino(){
        ...
        if ($server_ps->count()){
            ...
            //var_dump($server_ps); 
            return view('casino.casino', ['terminals' => $terminals, 'PsSettingsAttendant' => $PsSettingsAttendant, 'PsSettingsFree' => $PsSettingsFree, 'PsSettingsActive' => $PsSettingsActive, 'PsSettingsOffline' => $PsSettingsOffline, 'server_ps' => $server_ps, 'games' => $games]);
        } else {
